...
path_figures = "/home/pablo/Desktop/PhD/projects/BlastocystDev/figures/ERK_model_3/"
...
#ax.legend()
# PyPlot.tight_layout()
ax.set_xticks([1.0, 1.1, 1.2, 1.3, labs_end+2*labs_step])
ax.set_xticklabels([1.0, 1.1, 1.2, 1.3, "MEKi"])
